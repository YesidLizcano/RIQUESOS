  ...
  try {
    ...
    const response: DashboardMetricasResponse = {
      periodo: {
        ...
        volumenDobleCremaTajadosInternos: metricas.periodo.volumenDobleCremaTajadosInternos,
        volumenDobleCremaTajadosFabrica: metricas.periodo.volumenDobleCremaTajadosFabrica,
      ...
      desglosePorProducto: metricas.desglosePorProducto.map((dp) => ({
        ...
        dcTajadosInternos: dp.dcTajadosInternos,
        dcTajadosFabrica: dp.dcTajadosFabrica,
