...
export class PrismaLoteRepo implements LoteRepository {
  ...
  private toEntity(record: Prisma.LoteGetPayload<{}>): Lote {
    return new Lote({
      ...
      bloquesEnterosReempacados: record.bloquesEnterosReempacados,
      bloquesTajadosFabricaReempacados: record.bloquesTajadosFabricaReempacados,
      ...
      estado: asEstadoLote(record.estado),
        estadoPago: asEstadoPagoLote(record.estadoPago ?? EstadoPagoLote.PENDIENTE),
        metodoPagoLote: record.metodoPagoLote as MetodoPago,
        estadoPagoFlete: asEstadoPagoLote(record.estadoPagoFlete ?? EstadoPagoLote.PENDIENTE),
